...
import com.yuwubao.zytexpress.listener.OnListItemClickListener;
import com.yuwubao.zytexpress.listener.OnListItemLongClickListener;
import com.yuwubao.zytexpress.widget.LoadViewPullHelper;
...
/**
 * function
 * Created by mhdt on 2016/12/11.11:51
 * update by:
 */
public abstract class BaseRecycleViewAdapter extends RecyclerView.Adapter {
    ...
    public void setOnListItemLongClickListener(OnListItemLongClickListener
    ...
    class EmptyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(int position) {
            if (loadEmpty == TYPE_EMPTY) {
                loadhelper.loadEmpty();
            } else if (loadEmpty == TYPE_FAILED) {
                loadhelper.loadFailed();
            } else {
                loadhelper.hide();
            }
        }
