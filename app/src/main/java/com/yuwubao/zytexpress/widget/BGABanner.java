...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager
    ...
    private void initDefaultAttrs(Context context) {
        ...
        //#44aaaaaa
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#00000000"));
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.BGABanner_banner_isShowIndicator) {
            mIsShowIndicator = typedArray.getBoolean(attr, mIsShowIndicator);
        }
    }
    ...
    private void switchToPoint(int newCurrentPoint) {
        if (mIsShowIndicator)
            if (mPointRealContainerLl != null && mViews != null &&
                    (mIsNeedShowIndicatorOnOnlyOnePage ||
            ...
            if (mOnItemClickListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mOnItemClickListener.onBannerItemClick(BGABanner.this, view, mModels ==
                                null ? null : mModels
